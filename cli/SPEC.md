...
This is the preserved contract for optional experimental CLI tooling. The
default methodology lives in [../SPEC.md](../SPEC.md). The historical support
labels below describe the CLI's intended boundary; known implementation defects
remain documented in [README.md](README.md#known-experimental-limitations).
